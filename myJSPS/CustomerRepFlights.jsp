...
<table id="t01">
        ...
        <tbody>
     	...
     	try{
    		...
    		while(res.next()){
    		%>
    		<tr><form method="post" action="CustomerRepBooked.jsp">
    		<td><%=res.getString("flight_number")%></td><td><%=res.getString("destination_id")%></td><td><%=res.getString("departure_id")%></td><td><%=res.getString("airline_id")%></td><td><%=res.getString("aircraft_id")%></td><td><%=res.getString("flight_type")%></td><td><%=res.getString("depart_time")%></td><td><%=res.getString("Landing_time")%></td><td><%=res.getString("depart_date")%></td><td><%=res.getString("fare_economy")%>
