...
<body>
	<%
     	try{
			...
			String flightnumber=request.getParameter("flynum");
		    ...
		    PreparedStatement ps = con.prepareStatement("INSERT INTO `FlightReservationSystem`.`Ticket` (`ticket_number`, `user_name`, `round_trip`, `booking_fee`, `total_fare`,'flight_number') VALUES ('"+tcknum+" ', '"+User+"', '"+Ftype+"', '6', '"+farec+"'"+flightnumber+"');");
		    ps.executeUpdate();
