...
<body>
	...
	try {
		...
		ResultSet rs2  = stmt.executeQuery("Select user_name from Users where user_name='"+newUser+"'AND password='"+newpass+"'");
		rs2.next();
...
<br>
max#of stops<input name="maxs" type="number" min="0" value="0">
<br>
Airline
<Select  name="Airline">
